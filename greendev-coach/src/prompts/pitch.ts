...
export const FALLBACK_TEXT = `GreenDev Coach analyzed our repository and found $${0} in monthly cloud waste and measurable CO2 inefficiencies across compute, CI/CD, and containerization. By migrating to AWS Lambda, implementing CI caching, and optimizing our Docker images, we can reduce costs by over 80% and cut our carbon footprint by the same margin — this weekend, with zero architectural risk. These are not green compromises; they are best practices.`;
