...
export const RECOMMENDATIONS_CATALOG: Recommendation[] = [
  ...
  },
  {
    ...
    impact: 'HIGH',
    effort: 'LOW',
    awsAlternative: 'Use S3 as a cache backend for self-hosted runners.',
  ...
  },
  {
    ...
    impact: 'HIGH',
    effort: 'MEDIUM',
    awsAlternative: 'AWS Lambda + API Gateway',
  ...
  },
  {
    ...
    impact: 'HIGH',
    effort: 'LOW',
    awsAlternative: 'S3 Static Website + CloudFront CDN',
  ...
  },
  {
    ...
    impact: 'MEDIUM',
    effort: 'MEDIUM',
    awsAlternative: 'us-west-2 (primary), eu-north-1 (EU users)',
  ...
  },
  {
    ...
    impact: 'MEDIUM',
    effort: 'LOW',
    awsAlternative: 'EC2 t3.micro or AWS Lambda',
