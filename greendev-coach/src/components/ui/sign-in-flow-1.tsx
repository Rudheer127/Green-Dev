              ...
              >
                ...
                <div className="space-y-4">
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center justify-center gap-2 bg-white hover:bg-white/90 text-black border border-white rounded-full py-3 px-4 transition-colors disabled:opacity-75 disabled:cursor-not-allowed font-medium"
                  >
